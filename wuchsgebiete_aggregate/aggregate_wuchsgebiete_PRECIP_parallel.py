...
out_pth = r'O:\Student_Data\CJaenicke\00_MA\data\vector\lsp_metrics\wuchsgebiete\PRECIP_2018_wuchsgebiete.csv'
...
def workFunc(i):
    ...
    file_lst = [r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_precipitation\tiles\{0}\PRECIP_2018_v3_int.tif'.format(i) for i in tiles_lst]
    vrt_ind_pth = r'O:\Student_Data\CJaenicke\00_MA\data\vrt\wuchsgebiete\{1}_{0}_PRECIP_2018.vrt'.format(wuchs_name,
                                                                                                 wuchs_id)
