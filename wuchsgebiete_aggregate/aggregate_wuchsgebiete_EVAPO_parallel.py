...
out_pth = r'O:\Student_Data\CJaenicke\00_MA\data\vector\lsp_metrics\wuchsgebiete\EVAPO_2018_wuchsgebiete.csv'
...
def workFunc(i):
    ...
    file_lst = [r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_evapo_p\tiles\{0}\EVAPO_2018_int.tif'.format(i) for i in tiles_lst]
    vrt_ind_pth = r'O:\Student_Data\CJaenicke\00_MA\data\vrt\wuchsgebiete\{1}_{0}_EVAPO_2018.vrt'.format(wuchs_name,
                                                                                                 wuchs_id)
