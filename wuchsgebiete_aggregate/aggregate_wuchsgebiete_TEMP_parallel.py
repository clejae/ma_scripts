...
out_pth = r'O:\Student_Data\CJaenicke\00_MA\data\vector\lsp_metrics\wuchsgebiete\TEMP_2018_wuchsgebiete.csv'
...
def workFunc(i):
    ...
    file_lst = [r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_temperature\tiles\{0}\TEMP_2018_int.tif'.format(i) for i in tiles_lst]
    vrt_ind_pth = r'O:\Student_Data\CJaenicke\00_MA\data\vrt\wuchsgebiete\{1}_{0}_TEMP_2018.vrt'.format(wuchs_name,
                                                                                                 wuchs_id)
