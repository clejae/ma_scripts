...
#### ------------------------------ Stack month of 2018 ----------------------------- ####
# print("stacking")
# wd = r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_evapo_p\download\\'
#
# pth_lst = []
#
# for year in range(2018,2019):
#     for month in range(1,13):
#         pth = wd + r'grids_germany_monthly_evapo_p_{1}{0:02d}.tif'.format(month, year)
#         pth_lst.append(pth)
#
# ras_list = [gdal.Open(file) for file in pth_lst]
#
# out_pth =r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_evapo_p\time_series\EVAPO_2018.tif'
#
...
#### ------------------------------ Reproject to 3035 ----------------------------- ####
# print("reprojecting")
# in_pth = r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_evapo_p\time_series\EVAPO_2018.tif'
# out_pth = r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_evapo_p\time_series\EVAPO_2018_3035.tif'
#
...
# src_filename = r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_evapo_p\time_series\EVAPO_2018_3035.tif'
...
#
# # Output / destination
# dst_filename = r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_evapo_p\time_series\EVAPO_2018_3035_resampled.tif'
...
def workFunc(tile_name):
    print(tile_name)
    ras_pth = r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_evapo_p\tiles\\' + tile_name + r'\EVAPO_2018.tif'
    ras = gdal.Open(ras_pth)
    arr = ras.ReadAsArray()
    ...
    # arr = arr.astype(int)
    out_pth = r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_evapo_p\tiles\\' + tile_name + r'\EVAPO_2018_int.tif'
...
#
ttime = time.strftime("%a, %d %b %Y %H:%M:%S", time.localtime())
print("end: " + ttime)
#### ------------------------------ Set NA and change gdal datatype ----------------------------- ####
...
l = glob.glob(r'O:\Student_Data\CJaenicke\00_MA\data\climate\dwd_evapo_p\tiles\**\*.xml')
print(len(l))
for i in l:
    os.remove(i)
