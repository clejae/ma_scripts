...
out_df_tot = pd.DataFrame(index=tile_name_lst, columns=col_lst)
...
for i, month in enumerate(month_lst):
    for tile_name in tile_name_lst:
        ...
        out_df_tot.at[tile_name, col_lst[i]] = mean_tot

col_name_lst = ['Name', '_01', '_02', '_03', '_04', '_05', '_06', '_07', '_08', '_09', '_10', '_11', '_12']

# out_df_bl.index.name = 'Name'
# out_df_bl.reset_index(inplace=True)
# out_df_bl.columns = col_name_lst
#
# out_df_con.index.name = 'Name'
# out_df_con.reset_index(inplace=True)
# out_df_con.columns = col_name_lst
#
# out_df_gra.index.name = 'Name'
# out_df_gra.reset_index(inplace=True)
# out_df_gra.columns = col_name_lst

out_df_tot.index.name = 'Name'
out_df_tot.reset_index(inplace=True)
out_df_tot.columns = col_name_lst
...
out_name_tot = r'O:\Student_Data\CJaenicke\00_MA\data\vector\lsp_metrics\\'+abr+'_' + year + '.csv'
out_df_tot.to_csv(out_name_tot, index=False, decimal=".", sep=",")